...
let HomepageController = class HomepageController {
    ...
    constructor(homepageAggregateService) {
        this.homepageAggregateService = homepageAggregateService;
    }
    getHomepage() {
...
exports.HomepageController = HomepageController = __decorate([
    ...
    __metadata("design:paramtypes", [homepage_aggregate_service_1.HomepageAggregateService])
], HomepageController);
