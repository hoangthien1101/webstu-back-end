...
__decorate([
    (0, class_validator_1.IsNotEmpty)({ message: 'Mã nhân viên không được để trống' }),
    (0, class_validator_1.IsString)({ message: 'Mã nhân viên phải là chuỗi ký tự' }),
    __metadata("design:type", String)
], RegisterDto.prototype, "employeeCode", void 0);
__decorate([
    (0, class_validator_1.IsOptional)(),
    (0, class_validator_1.IsString)({ message: 'Ảnh đại diện phải là chuỗi ký tự' }),
    __metadata("design:type", String)
